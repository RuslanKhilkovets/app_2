...
export const routes = [
    ...
    { name: "SignForms", component: SignFormsScreen, options: { headerShown: false}}, 
    { name: "PrivacyPolicy", component: PrivacyPolicyScreen, options: { headerShown: false}}, 
    { name: "EmailConfirmation", component: EmailConfirmationScreen, options: { headerShown: false}}, 
]
