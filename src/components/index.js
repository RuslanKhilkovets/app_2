export {default as SignForm} from './SignForms/SignForm';
export {default as SignInForm} from './SignForms/SignInForm';
export {default as SignUpForm} from './SignForms/SignUpForm';
export {default as SignWithServices} from './SignForms/SignWithServices';

export {default as Slide1} from './sliders/StartSlider/slides/Slide1';
export {default as Slide2} from './sliders/StartSlider/slides/Slide2';
export {default as Slide3} from './sliders/StartSlider/slides/Slide3';
export {default as slides} from './sliders/StartSlider/slides/slides';

export {default as PrivacyPolicyBlock} from './containers/PrivacyPolicyBlock';
export {default as FavoriteBlock} from './containers/FavoriteBlock';
...
export {default as SelectLocationList} from './SelectLocation/SelectLocationList';
export {default as SelectLocationItem} from './SelectLocation/SelectLocationItem';
